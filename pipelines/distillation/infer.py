...
is the main inference script. Picks one random 16-frame test sequence,
runs it through a trained Swin3D checkpoint, and shows the predicted vs.
true label over a 4x4 frame grid. Equivalent logic also lives in
`predict.ipynb` for interactive/notebook use.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run distillation inference on one random test sequence.")
